      ...
      <div className="bg-white rounded-lg px-8 py-6 drop-shadow-sm">
        <div className="flex flex-col sm:grid grid-cols-2 gap-8">
          ...
          <div className="flex flex-col ">
            <p className="font-semibold text-gray-600 mb-2">Background Gone</p>
        ...
        <div className="flex justify-center sm:justify-end items-center flex-wrap gap-4 mt-6">
          ...
          <a
            className="px-8 py-2.5 text-white text-sm bg-gradient-to-r from-blue-500 via-cyan-400 to-emerald-400 rounded-full hover:scale-105 transition-all duration-700"
            href=""
          >
            Download image
          </a>
